...
int main()
{
    ...
    sendto(client, "client 1 is here", strlen("client 1 is here"), 0, (struct sockaddr *)&server_addr, addr_size);

    while (1)
    {
        memset(buffer, 0, BUFFER_SIZE);
        printf("Enter the message to client2:");
